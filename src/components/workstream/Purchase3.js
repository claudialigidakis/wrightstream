...
class Purchase extends React.Component {
  ...
  render () {
    ...
    return (
      <div>
        <div className="card">
          <header className="card-header status-red"></header>
              ...
              <div className="columns is-marginless">
                ...
                <div className="column is-6">
                  <div className="purchase-progress">
                    <a onClick={this.toggle}>Purchase #5</a>
                    <progress className="progress is-small" value="0" max="100" />
                  </div>
                </div>
          ...
          <div className="modal-content modal-purchase">
            <div className="columns is-marginless">
              <div className="column is-5 modal-sidebar">
                <div className="purchase-status status-yellow">
                  Backlog
                </div>
                <div className="purchase-header level">
                  <div className="level-left">
                    ...
                    <div className="level-item">
                      <h1 className="title is-5 is-marginless">Purchase #5</h1>
                    </div>
                  </div>
                  ...
                  <ul>
                    <li>
                      <div className="level">
                        <div className="level-left">
                          <div className="level-item">
                            <span className="lnr-cross2"></span> 3 oz Milk
                          </div>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div className="level">
                        <div className="level-left">
                          <div className="level-item">
                            <span className="lnr-cross2"></span> 1 oz Frosting
                          </div>
                        </div>
                      </div>
                    </li>
                        ...
                        <div className="level-left">
                          <div className="level-item">
                            <div className="field">
                              ...
                              <label htmlFor="cupcakes">1 Strawberry Cake</label>
                            </div>
                          </div>
                        </div>
                        <div className="level-right">
                  ...
                  <div>
                          ...
                          <div className="modal-container">
                            <div>
                              ...
                              <small>
                                {this.props.item.product === 'item' ? 'Item' : 'Bundle'}
                                {
