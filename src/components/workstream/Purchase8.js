              ...
              <div className="columns is-marginless">
                ...
                <div className="column is-6">
                  <div className="purchase-progress">
                    <a onClick={this.toggle}>Purchase #4</a>
          ...
          <div className="modal-content modal-purchase">
            <div className="columns is-marginless">
              <div className="column is-5 modal-sidebar">
                <div className="purchase-status status-red">
                  Finalize
                </div>
                <div className="purchase-header level">
                  <div className="level-left">
                    ...
                    <div className="level-item">
                      <h1 className="title is-5 is-marginless">Purchase #4</h1>
                    </div>
                  </div>
                        ...
                        <div className="level-left">
                          <div className="level-item">
                            <div className="field">
                              ...
                              <label htmlFor="cupcakes">12 Sugar Cookies</label>
                            </div>
                          </div>
                        </div>
                        <div className="level-right">
                      ...
                      <div className="level">
                        <div className="level-left">
                          <div className="level-item">
                            <div className="field">
                              <input className="is-checkradio" id="cupcakes" type="checkbox" name="cupcakes" checked />
                              <label htmlFor="cupcakes">12 Donuts</label>
                            </div>
                          </div>
                        </div>
                        <div className="level-right">
