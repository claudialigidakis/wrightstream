              ...
              <div className="columns is-marginless">
                ...
                <div className="column is-6">
                  <div className="purchase-progress">
                    <a onClick={this.toggle}>Purchase #7</a>
                ...
                <div className="column is-2 purchase-drag">
                  <span className="lnr-calendar-empty"></span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="column is-5 modal-sidebar">
                ...
                <div className="purchase-header level">
                  <div className="level-left">
                    ...
                    <div className="level-item">
                      <h1 className="title is-5 is-marginless">Purchase #7</h1>
                    </div>
                  </div>
                        ...
                        <div className="level-left">
                          <div className="level-item">
                            <div className="field">
                              ...
                              <label htmlFor="cupcakes">12 Chocolate Donuts</label>
                            </div>
                          </div>
                        </div>
                        <div className="level-right">
